...
if __name__ == '__main__':
    ...
    dataset = 'shoes'
    experiment_name = 'wrong_shoes_CosMo_eval'
    ...
    for DOMAIN in domains:
        ...
        parent_path = f'/home/jaehyun98/git/uncertain_retrieval/visualize_result/{experiment_name}/{DOMAIN}/'
        ...
        for cur_index in all_indexes:
            ...
            retrieved_image_path = os.path.join(cur_path, 'retrieved_images')
            ...
            textbox1 = slide.shapes.add_textbox(tb1_left, tb1_top, tb1_width, tb1_height)
            tf1 = textbox1.text_frame
            tf1.text = "Retrieved Images with Ambiguous Text"
        ...
        prs.save(f'{experiment_name}_FashionIQ_{DOMAIN}_ambiguous_text_analysis.pptx')